...
class _$_RegisterModel implements _RegisterModel {
  ...
  @override
  String toString() {
    return 'RegisterModel(name: $name, email: $email, password: $password, passwordConfirmation: $passwordConfirmation)';
  }
...
abstract class _RegisterModel implements RegisterModel {
  const factory _RegisterModel(
      ...
      final String? email,
      final String? password,
      final String? passwordConfirmation}) = _$_RegisterModel;
