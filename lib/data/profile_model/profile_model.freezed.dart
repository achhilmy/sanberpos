...
class _$_ProfileModel implements _ProfileModel {
  ...
  @override
  String toString() {
    return 'ProfileModel(fullName: $fullName, address: $address, phoneNumbers: $phoneNumbers, photoUrl: $photoUrl, userId: $userId, updatedAt: $updatedAt, createdAt: $createdAt, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, fullName, address, phoneNumbers,
      photoUrl, userId, updatedAt, createdAt, id);
